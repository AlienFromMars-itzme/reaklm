...
module.exports = {
  ...
  execute: async (client, message, args, emoji) => {
    ...
    let statsEmbed = new client.embed()
      ...
      .setFooter({
        text: `Page : [1/3] By ━● 1hp-Serviceㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,
      });
    let nodeStatsEmbed = new client.embed()
      ...
      .desc(
        [...client.manager.shoukaku.nodes.values()]
          .map(
            (node) =>
              `[**__${client.emoji.cog} ${node.name}__**](https://discord.gg/1hp-service)\n` +
      ...
      .setFooter({
        text: `Page : [2/3] By ━● 1hp-Serviceㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,
      });
    ...
    const graphEmbed = new client.embed().img(uri).setFooter({
      text: `Page : [3/3] By ━● 1hp-Serviceㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,
    });
