...
module.exports = {
  ...
  execute: async (client, message, args, emoji) => {
    const e1 = new client.embed()
      ...
      .setFooter({ text: `Page : [1/7] By ━● 1hp-Service` });
    ...
    const e2 = new client.embed()
      ...
      .setFooter({
        text: `Page : [2/7] By ━● 1hp-Service ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,
      });
    ...
    const e3 = new client.embed()
      ...
      .desc(
        `> **${emoji.king} [krypton_.](https://discord.gg/1hp-service) [Own & Dev]**\n` +
          `> **${emoji.partner} [nick.xd](https://discord.gg/1hp-service) [Co - Own]**\n` +
          `> **${emoji.dev} [not_a_coder](https://discord.gg/1hp-service) [Ex-owner of code]**\n`
      )
      .setFooter({
        text: `Page : [3/7] By ━● 1hp-Service ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,
      });
    ...
    const e4 = new client.embed()
      ...
      .desc(
        `> **${emoji.partner} [krishna03](https://discord.gg/1hp-service) [Friend]**\n`
      )
      .setFooter({
        text: `Page : [4/7] By ━● 1hp-Service ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,
      });
    ...
    const e5 = new client.embed()
      ...
      .desc(`> **${emoji.web} **HOSTZA** The best premium Host i've ever used**`)
      .img(
        "https://media.discordapp.net/attachments/1268670957313200139/1271156552140587209/powered-by-hostza.png?ex=66b6504a&is=66b4feca&hm=f8a1464fd71a46a18fce13663c6ff026d714abd362a4d7b20cdaa9955b1b37c8&"
      )
      .setFooter({
        text: `Page : [5/7] By ━● 1hp-Service ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,
      });
    ...
    const e6 = new client.embed()
      ...
      .setFooter({
        text: `Page : [6/7] By ━● 1hp-Service ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,
      });
    ...
    const e7 = new client.embed()
      ...
      .desc(
        `> **${emoji.partner}  [LNL](${client.invite.admin.replace(
          `${client.user.id}`,
          ``
        )}) [Antinuke]**\n`
      )
      .setFooter({
        text: `Page : [7/7] By ━● 1hp-Service ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,
      });
