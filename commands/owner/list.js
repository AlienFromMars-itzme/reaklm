...
module.exports = {
  ...
  execute: async (client, message, args, emoji) => {
    ...
    let emb = new client.embed().desc(
      `<:bot_arrow:1248187075539370058> **| Getting data. Please wait [ ETA: ${client.formatTime(
        estimate,
      )} ]**`,
    );
    ...
    for (id of ids) {
      ...
      names.push(
        `** ${
          entity.username
            ? `<:bot_arrow:1248187075539370058> [${entity.username}`
            : `<:bot_arrow:1248187075539370058> [${entity.name.substring(0, 15)}`
